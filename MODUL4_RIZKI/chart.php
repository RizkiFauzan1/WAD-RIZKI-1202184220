...
<div class="container">
  ...
  <thead>
    <tr>
      ...
      <th scope="col">Jumalah Barang</th>
  ...
  <tbody>
    <tr>
      ...
      <td>Rp.332.000</td>
      <td>2 PCS </td>
      <td><button type="button" class="button button-danger">Hapus</button></td>
      
    </tr>
    <tr>
      <th scope="row">2</th>
      <td>Sabun Mandi MS GLOW</td>
      <td>Rp.266.000</td>
      <td>2 PCS</td>
      <td><button type="button" class="button button-danger">Hapus</button></td>
...
<footer>
    <div class="container-fluid text-center">
      <div class="row">
        <div class="col-sm-9">
          <button type="button" class="btn btn-secondary btn-lg btn-block">&copy; copyright 2020 | built by <a
              href="https://www.instagram.com/telkomuniversity/?hl=en">Telkom University</button>
        </div>
      </div>
    </div>
