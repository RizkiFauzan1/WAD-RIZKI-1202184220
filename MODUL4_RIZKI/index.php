...
<div class="jumbotron jumbotron-fluid">
  <div class="container">
    <h2 align="center" class="h2">WAD BEAUTY</h2>
    <p align="center" class="lead">Skine care yang berasal dari alam</p>
  </div>
</div>
</div>
<div class="container">
<div class="card-group">
  <div class="card">
    ...
    <div class="card-body">
      <h5 class="card-title">SERUM MS GLOW</h5>
      <p class="card-text">Produk terbaru dari somebymi yang memiliki manfaat untuk Whitening + blemish care + anti wrinkle, sangat recomended untuk masalah kulit kusam kering dan bekas jerawat atau FLEK hitam </p>
      <p class="card-text">RP.166.000</p>
      <button class="btn btn-primary"href="chart.php" type="BUY">BUY</button>
    </div>
  </div>
  <div class="card">
    <img class="card-img-top" src="m2.jpg" alt="Card image cap">
    <div class="card-body">
      <h5 class="card-title">SABUN MANDI MS GLOW</h5>
      <p class="card-text">Sebagai pelembap, krim ini mampu memberikan kelembapan yang menyeluruh dan tahan lama bagi kulit sehingga terasa halus. </p>
      <p class="card-text">RP.133.000</p>
      <button class="btn btn-primary" href="chart.php" type="BUY">BUY</button>
    </div>
  </div>
  <div class="card">
    <img class="card-img-top" src="ms.jpg" alt="Card image cap">
    <div class="card-body">
      <h5 class="card-title">OBAT NYAMUNG MS GLOW</h5>
      <p class="card-text">Dengan kandungan AHA, BHA dan PHA bekerja secara efektif untuk membuat kulit lebih bersih dan lebih bersinar, mengandung 10.000 ppm</p>
