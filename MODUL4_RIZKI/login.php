...
<form method="post" action="login.php">
    ...
    <h3>LOGIN WAD BEATUY</h3>
    <form action="Login-process.php" methode="POST">
    
    <div>
      <label for="username">E-mail</label><br>
      <input type="text" name="txtE-mail" id="e-mail" placeholder="Masukan E-mail" autofokus autocomplete="off" required><br>
    </div>
    
    <div>
      <label for="Kata Sandri">Kata Sandi</label><br>
      <input type="text" name="txtKata-Sandi" id="katasandi" placeholder="Masukan Kata Sandi"required><br>
      <input type='checkbox' name='inget' value=' Remember Me' /> Remember Me</p>

      <div class="clearfix"></div>
      <hr> 
      <button class="button button-primary " type="LOGIN" href="index.php">LOGIN </button><br>
      <div class="row">
                <div class="col">
                     <p>Sudah Punya Akun?</p>
           <a href="registrasi.php" >REGISTRASI DULU</a>
          </div>
    </div>
    </div>
